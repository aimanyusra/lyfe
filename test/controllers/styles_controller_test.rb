...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { name: @style.name, tags: @style.tags, user_id: @style.user_id } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { name: @style.name, tags: @style.tags, user_id: @style.user_id } }
